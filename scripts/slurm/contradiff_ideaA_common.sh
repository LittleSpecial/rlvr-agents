...
USE_CRITICALITY_PREDICTOR="${USE_CRITICALITY_PREDICTOR:-0}"
...
echo "USE_CRITICALITY_PREDICTOR=${USE_CRITICALITY_PREDICTOR} CRITICALITY_HIDDEN_DIM=${CRITICALITY_HIDDEN_DIM}"
echo "CRITICALITY_LOSS_WEIGHT=${CRITICALITY_LOSS_WEIGHT} ACTION_CONTRASTIVE_WEIGHT=${ACTION_CONTRASTIVE_WEIGHT}"
echo "ACTION_EMBD_DIM=${ACTION_EMBD_DIM} GUIDANCE_SCALE_BOOST=${GUIDANCE_SCALE_BOOST}"
...
export USE_CRITICALITY_PREDICTOR
export CRITICALITY_HIDDEN_DIM
export CRITICALITY_LOSS_WEIGHT
export ACTION_CONTRASTIVE_WEIGHT
export ACTION_EMBD_DIM
export GUIDANCE_SCALE_BOOST
